...
17-bin sectional scheme to represent both internally and externally mixed particles, while DALES modifies the seven-mode M7 model
...
$1.0\%$). Lastly, we explore the governing role of aerosol
composition--namely, the presence of ammonia---in mediating the impact
of emissions spatial heterogeneity on CCN activity.
\textcolor{red}{Add mention of additional results in response to reviewers}
...
these species into the aerosol phase to form ammonium nitrate. Comparing modeled ammonium and nitric acid levels with past studies, concentrations of each are consistent with brief, extremely polluted conditions found in regions with a large volume of vehicular emissions, such as Southern California \citep{salmon_nitric_1990, toro_sensitivity_2024}.   
...
Simulations in this study assume a horizontally
...
surface heterogeneity, wind shear, and diurnal variability. Additionally,
