...
%DIF ADD 4_revised_paper/paper_sh_impacts_aerosol.tex     Tue Feb 10 10:33:13 2026
%% ---------------------------------
...
spatially heterogeneous emissions \citep{qian_investigation_2010}, yet \DIFdelbegin \DIFdel{many climate models fail to resolve this variability adequately}\DIFdelend \DIFaddbegin \DIFadd{most climate modelsdo not represent this variabilkity explicitly in a general sense. Existing parameterizations in global climate models for sub-grid scale emissions and associated processes are typically limited to specific phenomena such as ship tracks \mbox{%DIFAUXCMD
...
, rather than providing a general treatment of emissions-driven aerosol heterogeneity}\DIFaddend .
