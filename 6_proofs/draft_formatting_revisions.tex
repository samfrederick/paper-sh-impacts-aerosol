...
%% Fix for babel not loading English captions with newer TeXLive
\providecommand{\introductionname}{Introduction}
\providecommand{\conclusionname}{Conclusions}
\providecommand{\authorcontributionname}{Author contributions}
\providecommand{\codedataavailabilityname}{Code and data availability}
\providecommand{\codeavailabilityname}{Code availability}
\providecommand{\dataavailabilityname}{Data availability}
\providecommand{\competinginterestsname}{Competing interests}
\providecommand{\acknowledgementsname}{Acknowledgements}
\providecommand{\acknowledgementname}{Acknowledgement}
\providecommand{\copyrightstatementname}{Copyright statement}
\providecommand{\disclaimername}{Disclaimer}
\providecommand{\financialsupportname}{Financial support}
\providecommand{\reviewstatementname}{Review statement}
\providecommand{\dosupplementname}{Supplement}
...
spatially heterogeneous emissions \citep{qian_investigation_2010}, yet most climate models do not explicitly represent this variability in a general sense. Existing parameterizations in global climate models for sub-grid scale emissions and associated processes are typically limited to specific phenomena such as ship tracks \citep{huszar_modeling_2010} and contrails \citep{burkhardt_processbased_2009}, rather than providing a general treatment of emissions-driven aerosol heterogeneity.
...
\begin{figure*}[!t]
	\centering
	\includegraphics[]{figures/fig1_SH-scenarios.pdf}
...
\citep{mohebalhojeh_metric_2026}. The metric $\eta$ is a normalized
...
\begin{equation}
\eta(f, S) = \frac{2\sum_{\tilde{S}\in \textcolor{red}{D}}|\overline{f}(S) - \overline{f}(\tilde{S})|}{MN\overline{f}(S)\left[3MN-M-N-1\right]}, 
\end{equation}
where $\overline{f}(S)$ is the domain mean, $\overline{f}(\tilde{S})$ is the mean over a subset of the domain
$\tilde{S}$, and \textcolor{red}{$D$} is the set of all possible subdomains. Thus, the metric is computed by averaging the absolute
...
maximum possible value of this average difference given a fixed domain mean. \citet{mohebalhojeh_metric_2026} show that the metric is
...
\begin{figure}[!h]
	\centering
	\includegraphics[]{figures/fig2_vert-prof-temp-rh.pdf}
...
307~K due to constant surface heating, while the upper part of the
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig3_gas-spatial-heterogeneity-time36-z45.pdf}
...
Conversely, when the gas phase concentration of nitric acid is high such as near an 
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig4_gas-vertical-profiles-time36.pdf}
...
acid mixing ratios decrease on average. As will be demonstrated in
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig5_combined_num_mass_conc_i50_j50_k60.pdf}
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig6_aero-spatial-heterogeneity-time36-z45.pdf}
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig7_aerosol-SNA-vertical-profiles-time36.pdf}
...
(VOCs) compete alongside SO$_2$ for oxidation. With OH rapidly
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig8_speciated-mass-frac-three-panel-z40.pdf}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[]{figures/fig9_2d-kappa-dist-three-panel-z40.pdf}
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig10_aerosol-ccn-vertical-profiles-time36.pdf}
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig11_height-time-ccn-pdiff-multi-scenario.pdf}
...
\begin{figure}[!h]
	\centering
	\includegraphics[]{figures/fig12_ammonia-free-vertical-profiles-time36.pdf}
...
\begin{figure}[!h]
	\centering
	\includegraphics[]{figures/fig13_high-het-relaxation.pdf}
...
Gas–particle partitioning of semivolatile species is strongly modulated by ambient relative humidity, as water uptake can promote co-condensation well below water saturation, altering particle size and composition prior to activation \citep{topping_tight_2012}. 
...
\begin{figure}[!h]
	\centering
	\includegraphics[]{figures/fig14_sna-rh-matrix.pdf}
...
\begin{figure*}[!h]
	\centering
	\includegraphics[]{figures/fig15_ccn-rh-matrix.pdf}
...
\codedataavailability{WRF-PartMC is open source and maintained on GitHub: https://github.com/open-atmos/wrf-partmc.git (last access: 3 Apr. 2026). The version of
...
All simulation outputs and scripts used to generate figures in this paper are available via the Illinois Data Bank: https://doi.org/10.13012/B2IDB-9622921\_V3 (last access: 3 Apr. 2026).} %% use this section when having data sets and software code available
...
\financialsupport{This research has been supported by the U.S. Department of Energy, Office of Science, Biological and Environmental Research program (grant no. DE-SC0022130), and by the
National Science Foundation (grant no. AGS 19-41110).}
