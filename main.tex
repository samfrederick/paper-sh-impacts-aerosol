...
Present aerosol-aware models at regional and global scales possess insufficient resolution to capture the full spatial heterogeneity of aerosols and the emissions of primary aerosols and gas phase precursors. 
%(\hl{Maybe mention that this includes coarser scale GCMs at 50--100 km and higher resolution cloud-resolving models at approx 1 km res.}).  
In turn, these models depict artificially dilute and uniform concentrations within grid cells. This alters the representation of concentration-dependent, non-linear aerosol processes such as coagulation and gas particle partitioning. Past studies have shown that climate-relevant aerosol properties such as aerosol optical properties \citep{gustafson_jr_downscaling_2011} and CCN activity \citep{weigum_effect_2016} are highly sensitive to the model’s grid resolution with a large contribution of sub-grid scale variability resulting from the spatially varying pattern of emissions \citep{qian_investigation_2010}. Given large uncertainties in the effective radiative forcing resulting from aerosol-cloud interactions \citep{ipcc_report_2021}, constraining model estimates of CCN activity remains an important focus. 
...
%Aerosols alter Earth's radiative budget both directly through scattering and absorption of radiation and indirectly through aerosol-cloud interactions. Aerosol-cloud interactions are driven by hygroscopic aerosol particles which act as cloud condensation nuclei (CCN), thus allowing water vapor to condense onto their surface at ambient supersaturations $S$ typical of the troposphere. The global mean effective radiative forcing (ERF) due to the combination of direct and indirect effects is estimated by the Intergovernmental Panel on Climate Change (IPCC) to be in the range of $−2.0$ to $−0.6$~W~m$^{−2}$ within 95\% confidence, with a mean of $−1.3$~W~m$^{−2}$ \citep{ipcc_report_2021}. Separating the ERF into forcing due to aerosol-cloud interactions and direct radiative forcing, aerosol-cloud interactions contribute the largest magnitude of forcing in the range $−1.7$ to $−0.3$~W~m$^{−2}$ with a mean of $−1.0$~W~m$^{−2}$. Direct effects contribute $−0.6$ to $0.0$~W~m$^{−2}$ with a mean of $−0.3$~W~m$^{−2}$. Uncertainty in the ERF due to aerosol-cloud interactions remains poorly constrained due to numerous reasons, including limited understanding of the coupling between microphysical phenomena and cloud macrophysical structure in deep convective clouds (Fan et al. 2016 - try to find a better reference than this review article). Furthermore, the abundance of CCN affects cloud properties (morphology, lifetime, etc), altering their indirect radiative forcing; however, there is poor agreement among models regarding CCN concentrations due to simplified representation of the aerosol, transport treatment, and the underlying spatial heterogeneity of emissions. Therefore, constraining estimates of CCN concentrations is important to improving understanding of aerosol-cloud interactions, their feedbacks, and resulting radiative forcing. 

%\item GCMs do a poor job of predicting CCN activity

%The spread in predicted CCN concentrations in global climate models (GCMs) remains large due to uncertainty resulting from the structural representation of physical processes within the modeling framework, including transport and the representation of aerosols. We refer to such uncertainty as structural uncertainty. Global and regional scale models typically represent transport via Reynolds-averaged Navier-Stokes (RANS) in which the mean flow is explicitly modeled while turbulent transport is fully parameterized. The transport and dispersion of emitted compounds in the boundary layer is largely governed by turbulent eddies resulting from free and forced convection, and thus GCMs are not able to properly resolve the mixing and transport of emitted compounds in the boundary layer. 

%Furthermore, the prediction of CCN concentrations in GCMs is impacted by the inability of such models to represent the spatial scales of both biogenic and anthropogenic emissions (examples?) such as the release of inorganic gas phase compounds such as SO$_2$ and NO$_x$ from industrial processes and vehicular combustion alongside primary aerosol such as black and brown carbon. Models with resolution coarser than the scale of spatially varying emissions depict diffuse and uniform concentrations within in each grid cell. Due to the concentration dependent nature of key aerosol processes and the reactivity of precursor gas phase compounds, coarser resolved models such as GCMs exhibit structural uncertainty in their representation of aerosol properties including CCN activity. In addition to depicting emissions as artificially dilute, models with coarse spatial resolution do not capture the chemical segregation (i.e., the degree to which reactive compounds are spatially segregated or collocated) of chemical species.

%\begin{itemize}
%\item It is well established that the chemical segregation of gas phase compounds alters reactivity and is highly dependent on the ratio of turbulent and reactive timescales. Given the coupling between the gas phase and aerosols through gas-particle partitioning, chemical segregation due to spatial heterogeneity of emissions likely influences the aerosol state.
