...
\textbf{(1.2)} Could you use a proﬁle where there’s a more humid boundary layer? I think a
...
\textbf{(1.5)} Following from question 4 above, emission ﬂux data observations are not at 100
...
\textbf{(1.6)} For some of the ﬁgures, for example Figure 7, it would be nice to give the
