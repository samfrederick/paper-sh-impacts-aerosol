...
\begin{itemize}
    ...
    \begin{itemize}
      \item Vertical-level averaged environmental conditions (temperature, RH): \newline \texttt{no-heterogeneity\_met-vars\_subset.nc}
      ...
      \item Detailed per-particle output (e.g., per-particle mass fractions, kappa): \newline \texttt{crosssec\_no-heterogeneity\_t0\_z40.nc},  \texttt{crosssec\_*\_t36\_z40.nc}
