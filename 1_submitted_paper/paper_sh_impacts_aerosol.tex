...
and (2) the treatment of aerosol representation, \textcolor{red}{which
  refers to how aerosol properties such as size distribution, chemical
  composition, and mixing state are modeled.}
...
\textcolor{red}{General comment: If we refer to a specific scenario, I
  think cenario should be written with capital ``S''.}
