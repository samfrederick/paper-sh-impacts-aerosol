...
\begin{equation}
\eta(f, S) = \frac{2\sum_{\tilde{S}\in \mathbf{R}}|\overline{f}(S) - \overline{f}(\tilde{S})|}{MN\overline{f}(S)\left[3MN-M-N-1\right]}, 
\end{equation}
...
\begin{figure}[!h]
	...
	\caption{Cross sections in the x-y plane of aerosol species
          ...
          species in parts per billion by volume. Regions below a trace concentration of $10$~pptv are filled in white. The value of the
