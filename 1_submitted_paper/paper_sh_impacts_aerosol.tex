...
\begin{figure}[!t]
     \centering
	\includegraphics[]{figures/sounding.pdf}
	\caption{Vertical profiles for the initial condition of potential temperature ($\theta$) and water vapor mixing ratio ($w$).}
	\label{fig:sounding}
\end{figure}
...
km. The wind profile is set to zero throughout the domain. Vertical profiles
for the initial condition of potential temperature and the water vapor 
mixing ratio are shown in Figure \ref{fig:sounding}.
